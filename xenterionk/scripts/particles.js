...
let knop0 = document.getElementById('n0');
let knop1 = document.getElementById('n1');
let knop2 = document.getElementById('n2');
let knop3 = document.getElementById('n3');
let knop4 = document.getElementById('n4');
knop.addEventListener("click", removebar);
knop0.addEventListener("click", addbar);
knop1.addEventListener("click", addbar);
knop2.addEventListener("click", addbar);
knop3.addEventListener("click", addbar);
knop4.addEventListener("click", addbar);
var counter2 = 0;
...
function removebar() {
	...
	if(counter2 === 0) {
		document.getElementById('btn').classList.remove("fa-bars");
		document.getElementById('btn').classList.remove("barinfo");
		counter2++;
	} 
	else {
		document.getElementById('btn').classList.add("fa-bars");
		document.getElementById('btn').classList.add("barinfo");
		counter2--;
	}
